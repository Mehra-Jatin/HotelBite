...
import { addHotel, addItem, deleteItem, getMenu, getMenuItems, getOrdersByHotel, getPartnerHotels, getRestaurantOrders, removeHotel, updateDeliveryStatus, updateItem, updateItemAvailability, updateMenuAvailability, updatePaymentStatus, updatePendingPayment } from '../controllers/resturantController.js';
...
router.put('/update-menu-availability',authMiddleware, updateMenuAvailability); // Update menu availability in the restaurant's menu
router.put('/update-item-availability/:id',authMiddleware, updateItemAvailability); // Update item availability
